package io.smarthome.mesh.bluetooth.connecting
...
import io.smarthome.mesh.bluetooth.BLELiveDataCallbacks
import io.smarthome.mesh.bluetooth.BTCharacteristicWriter
import io.smarthome.mesh.bluetooth.btAdapter
import io.smarthome.mesh.bluetooth.connecting.ConnectionState.DISCONNECTED
import io.smarthome.mesh.common.QATool
import io.smarthome.mesh.common.truthy
import io.smarthome.mesh.setup.connection.BT_SETUP_RX_CHARACTERISTIC_ID
import io.smarthome.mesh.setup.connection.BT_SETUP_SERVICE_ID
import io.smarthome.mesh.setup.connection.BT_SETUP_TX_CHARACTERISTIC_ID
import io.smarthome.mesh.setup.flow.Scopes
import io.smarthome.mesh.setup.ui.utils.buildMatchingDeviceNameSuspender
import io.smarthome.mesh.setup.utils.checkIsThisTheMainThread
