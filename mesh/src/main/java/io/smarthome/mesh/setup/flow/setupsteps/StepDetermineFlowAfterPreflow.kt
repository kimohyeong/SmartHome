...
import io.smarthome.mesh.setup.flow.FlowIntent.FIRST_TIME_SETUP
import io.smarthome.mesh.setup.flow.FlowIntent.SINGLE_TASK_FLOW
import io.smarthome.mesh.setup.flow.context.NetworkSetupType
import io.smarthome.mesh.setup.flow.context.NetworkSetupType.AS_GATEWAY
import io.smarthome.mesh.setup.flow.context.NetworkSetupType.NODE_JOINER
import io.smarthome.mesh.setup.flow.context.NetworkSetupType.STANDALONE
import io.smarthome.mesh.setup.flow.context.SetupContexts
import io.smarthome.mesh.setup.flow.context.SetupDevice
