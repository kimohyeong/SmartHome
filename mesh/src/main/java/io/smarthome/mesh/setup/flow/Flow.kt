...
import io.smarthome.firmwareprotos.ctrl.Network.InterfaceEntry
...
import io.smarthome.mesh.setup.flow.modules.bleconnection.BLEConnectionModule
import io.smarthome.mesh.setup.flow.modules.cloudconnection.CloudConnectionModule
import io.smarthome.mesh.setup.flow.modules.device.DeviceModule
import io.smarthome.mesh.setup.flow.modules.device.NetworkSetupType
import io.smarthome.mesh.setup.flow.modules.device.NetworkSetupType.AS_GATEWAY
import io.smarthome.mesh.setup.flow.modules.device.NetworkSetupType.JOINER
import io.smarthome.mesh.setup.flow.modules.device.NetworkSetupType.STANDALONE
import io.smarthome.mesh.setup.flow.modules.meshsetup.MeshNetworkToJoin.CreateNewNetwork
import io.smarthome.mesh.setup.flow.modules.meshsetup.MeshNetworkToJoin.SelectedNetwork
import io.smarthome.mesh.setup.flow.modules.meshsetup.MeshSetupModule
