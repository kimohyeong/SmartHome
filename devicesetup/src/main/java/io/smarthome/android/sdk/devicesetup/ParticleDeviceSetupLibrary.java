...
import io.smarthome.android.sdk.di.ApplicationComponent;
import io.smarthome.android.sdk.di.ApplicationModule;
import io.smarthome.android.sdk.di.DaggerApplicationComponent;
...
public class ParticleDeviceSetupLibrary {
    ...
    /**
     * @deprecated This exists only because {@link io.smarthome.android.sdk.ui.NextActivitySelector}
     * is in a different package, and the plan is to remove that class soon.
     * As soon as {@link io.smarthome.android.sdk.ui.NextActivitySelector} is removed, this will be removed.
     */
    @Deprecated
