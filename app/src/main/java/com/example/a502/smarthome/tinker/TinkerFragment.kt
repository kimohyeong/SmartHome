...
import com.example.a502.smarthome.ui.DeviceActionsHelper
import com.example.a502.smarthome.ui.DeviceMenuUrlHandler
import com.example.a502.smarthome.utils.Prefs
...
class TinkerFragment : Fragment(), OnClickListener {
    ...
    companion object {
        ...
        fun newInstance(device: ParticleDevice): TinkerFragment {
            return TinkerFragment().apply { arguments = bundleOf(ARG_DEVICE to device) }
        }
    }
